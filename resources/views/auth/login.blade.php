                        ...
                        <div class="row g-0">
                            <div class="col-lg-6">
                                <div class="card-body p-md-5 mx-md-4">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <br> </br>
                                        <h4 class="mt-1 mb-5 pb-1">Método de calificación Ingeniería de Sistemas Unimar.
                                        </h4>
                                    </div>
                                    ...
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="form-outline mb-4">
                                            ...
                                            @enderror
                                            <label class="form-label" for="ejemplo@umariana.edu.co">Correo
                                                Electronico</label>
                                        </div>
                            ...
                            <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                                <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                                    ...
                                    <p class="small mb-0">El Programa de Ingeniería de Sistemas de la Universidad
                                        Mariana procura la formación
                                        integral del Ingeniero de Sistemas tanto en sus aspectos humanísticos como
                                        científicos que lo posibilita
                                        ...
                                        organizacionales del entorno local, regional, nacional e internacional, siempre
                                        actuante bajo los
