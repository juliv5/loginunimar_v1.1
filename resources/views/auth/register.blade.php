                            ...
                            <div class="col-lg-6">
                                <div class="card-body p-md-5 mx-md-4">
                                    ...
                                    <form action="{{route('login')}}" method="post">
                                        @csrf
                                        <center><b>INGRESA TUS DATOS</b></center>
                                        <br> </br>

                                        <div class="form-outline mb-4">
                                            <input type="text" name="name" id="form2Example11" class="form-control" placeholder="Ingresar nombre" />
                                            <label class="form-label" for="Juliana Velandia">Nombre</label>
                                        </div>
                                        <div class="form-outline mb-4">
                                            <input type="email" name="email" id="form2Example11" class="form-control" placeholder="Ingresar correo electronico" />
                                        ...
                                        <div class="form-outline mb-4">
                                            <input type="password" name="password_confirmation" id="form2Example22" class="form-control" placeholder="Ingresa nuevamente tu contraseña" />
                                            <label class="form-label" for="form2Example22">Confirmar contraseña</label>
                                        </div>

                                        <div class="text-center pt-1 mb-5 pb-1">
                                            <a href="{{route('home')}}" class="btn btn-outline-danger">Registrarse</a>
                                        </div>

                                        <div class="d-flex align-items-center justify-content-center pb-4">
                                            <p class="mb-0 me-2">Volver al inicio de sesión</p>
                                            <br> </br>
